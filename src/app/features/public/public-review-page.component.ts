...
import { getPlatformIcon, getPlatformButtonClasses, getPlatformDisplayName } from '../../shared/utils';
...
export class PublicReviewPageComponent implements OnInit {
  ...
  onLinkClick(link: ReviewLink) {
    ...
    this.analyticsService.logClick(link.business_id, link.platform_name).subscribe({
      error: err => {
